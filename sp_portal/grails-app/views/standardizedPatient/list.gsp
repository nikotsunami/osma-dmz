            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <g:sortableColumn property="origId" title="${message(code: 'standardizedPatient.origId.label', default: 'Original Id')}" />
                ...
                <g:each in="${standardizedPatientInstanceList}" status="i" var="standardizedPatientInstance">
                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                        ...
                        <td>${fieldValue(bean: standardizedPatientInstance, field: "origId")}</td>
