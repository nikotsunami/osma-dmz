...
<body>
	...
	<div id="Layer1" style="height:100%">
		<h1>&nbsp;&nbsp;&nbsp;&nbsp;Training Days</h1>
		...
		<div id="Layer3">
			<g:if test="${availableTrainingDays!=null}">
  				<table style="height:100%">
					<tr>
							<g:sortableColumn property="trainingDate" title="${message(code: 'training.date')}" />
  			...
  			<g:each in="${availableTrainingDays}" status="i" var="availableTrainingDay">
    				<tr>
						  <td align="center">${fieldValue(bean: availableTrainingDay, field: "trainingDate")}</td>
						  <td align="center">${fieldValue(bean: availableTrainingDay, field: "timeStart")}</td>
						  <td align="center">${fieldValue(bean: availableTrainingDay, field: "timeEnd")}</td>
		...
		<div id="Layer5" align="center">
  		...
  		<div id="Layer6">
    		<table width="600">
				<tr>
					<g:sortableColumn property="osceDate" title="${message(code: 'osce.date', default: 'Date')}" /></tr>
					<g:if test="${availableOsceDays!=null}">
						<g:each in="${availableOsceDays}" status="i" var="availableOsceDay">
      						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							<td align="center">${fieldValue(bean: availableOsceDay, field: "osceDate")}</td>
