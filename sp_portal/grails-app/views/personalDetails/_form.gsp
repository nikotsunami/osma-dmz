...
<div class="fieldcontain ${hasErrors(bean: standardizedPatientInstance, field: 'immagePath', 'error')} ">
    <label for="immagePath">
        <g:message code="standardizedPatient.immagePath.label" default="Immage Path" />

    </label>
    <g:textField name="immagePath" value="${standardizedPatientInstance?.immagePath}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: standardizedPatientInstance, field: 'videoPath', 'error')} ">
    <label for="videoPath">
        <g:message code="standardizedPatient.videoPath.label" default="Video Path" />

    </label>
    <g:textField name="videoPath" value="${standardizedPatientInstance?.videoPath}"/>
</div>
