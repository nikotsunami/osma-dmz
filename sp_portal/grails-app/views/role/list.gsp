			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="roleDescription" title="${message(code: 'role.roleDescription.label', default: 'Role Description')}" />
				...
				<g:each in="${roleInstanceList}" status="i" var="roleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${roleInstance.id}">${fieldValue(bean: roleInstance, field: "roleDescription")}</g:link></td>
